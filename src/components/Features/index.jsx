            ...
            <div className='flex w-full flex-wrap items-center'>
                                    ...
                                    <div className='flex items-end gap-1'>
                                        ...
                                        <div className='flex flex-col gap-1 items-start justify-start'>
                                            ...
                                            <motion.div
                                                ...
                                                variants={popVariant3}
                                            >
                                                <img className='h-[100px] w-fit rounded-sm' src={aiImage} alt='AI' />
                                            </motion.div>
                                            <motion.div
                                                initial="hidden"
                                                animate="visible"
                ...
                <div className='w-full md:w-full lg:w-[50%] mt-14 md:mt-14'>
                    <AnimatePresence mode='wait'>
                        ...
                        >
                            {expandedIndex === 0 ? "Architecting Ethical AI Futures" : (expandedIndex === 1 ? "Decoding the DNA of Responsible AI" : "")}
                        </motion.h2>
                        <motion.p
