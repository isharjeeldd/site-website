      ...
      <div className={`${container}`}>
        <motion.h1
          className="
            ...
            text-[30px] leading-[35px] font-semibold
            sm:text-[38px] sm:leading-[40px]
            md:text-[65px] md:leading-[70px] md:gap-3
            lg:text-[75px] lg:leading-[75px] lg:gap-4
            xl:text-[90px] xl:leading-[90px] xl:gap-6 xl:font-medium
          "
          variants={staggerContainer}
          initial="hidden"
          animate="visible"
        >
          <motion.span className="ml-0 sm:ml-[-200px]" variants={textVariant}>
            Bridging the
          </motion.span>
          <motion.span className="ml-0 sm:ml-14" variants={textVariant}>
            gap between AI
          </motion.span>
          ...
          >
            <motion.span
              className="absolute bg-secondary rounded-xl
                h-[40px] sm:h-[60px] md:h-[80px] lg:h-[100px] xl:h-[100px]
                w-full max-w-[40%] sm:max-w-[35%] md:max-w-[30%] lg:max-w-[25%] xl:max-w-[30%]"
              initial={{ width: 0 }}
              animate={{ width: `${scrollProgress * 3}%` }}
