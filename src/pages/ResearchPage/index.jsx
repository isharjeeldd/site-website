...
const ResearchPage = () => {
    return (
        <>
            ...
            <div className='bg-tertiary px-4 py-[200px]'>
                <h1 className='text-white mx-auto text-start lg:text-center w-full sm:w-[60%] font-[500] text-[32px] leading-[60px]'>Pushing the boundaries of AI ethics research. Our insights today shape the policies of tomorrow</h1>
            </div>
            <div className='mb-[150px]'>
