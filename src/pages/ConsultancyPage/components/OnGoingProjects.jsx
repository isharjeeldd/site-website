    ...
    return (
        <div className='my-[80px] lg:my-[150px]'>
            <div className={`${container}`}>
                <h1 className='text-black font-[600] text-start lg:text-center'>Testimonials</h1>
                <p className={`${paragraph} text-start lg:text-center mt-6 sm:w-[50%] w-full mx-auto`}>Our commitment to Ethical AI isn’t just a promise—it’s a practice reflected in the voices of our partners and clients.</p>
