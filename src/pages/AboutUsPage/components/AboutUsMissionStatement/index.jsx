...
const AboutUsMissionStatement = () => {
    ...
    return (
        <section className='bg-our-mission-bg h-full lg:h-[1200px] bg-no-repeat bg-cover grid items-center justify-center w-full' aria-labelledby="founding-heading">
            <div className={`${container} relative`}>
                ...
                >
                    <div className='w-[89%] mx-auto flex flex-col items-center justify-center h-full px-10 pt-16'>
                        <h2 id="founding-heading" className='text-[26px] font-medium mb-6 lg:mt-0 mt-14 text-foreground'>SITE&apos;s Founding and History</h2>
                        <p className={`${paragraph} !text-[14px] pb-7 !leading-6 lg:!text-[17px] lg:!leading-8 text-justify mt-3 dark:!text-muted-foreground`}>
            ...
            <div className={`${container} mt-[150px]`}>
                <div className='flex flex-wrap items-center justify-center gap-12'>
                    <motion.div
                        ...
                        viewport={{ once: true }}
                    >
                        <h2 className='text-[26px] text-white font-medium'>Our Mission</h2>
                    ...
                    >
                        <LazyImage
                            src={OurMissionImage}
                            alt='Our Mission - team working on AI ethics'
